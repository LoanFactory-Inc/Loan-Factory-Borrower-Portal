...
/**
 * Responsive width ladders. Each tier grows step-by-step across breakpoints
 * instead of jumping straight to a single fixed cap, so dialogs stay flexible
 * from mobile up to large desktops. Heights are capped to keep tall forms
 * scrollable rather than overflowing the viewport.
 */
const dialogContentSizes = {
  ...
  "3xl": "sm:max-w-3xl md:max-w-4xl lg:max-w-5xl",
  "5xl": "sm:max-w-3xl md:max-w-4xl lg:max-w-5xl xl:max-w-6xl 2xl:max-w-7xl",
} as const;
